...
class MustBeAnArrayError extends common_1.RuntimeError {
    constructor(message) {
        super(eav_errors_1.ErrorNamespaces.EAV, eav_errors_1.ErrorCodes.TYPE_OF_VALUE_MUST_BE_A_ARRAY, message !== null && message !== void 0 ? message : 'EAV attribute value must be a array');
    }
}
